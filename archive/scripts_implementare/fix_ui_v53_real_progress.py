...
for line in lines:
    if "with tabs[2]:" in line:
        ...
        # Calculăm indentarea de bază a liniei 'with'
        base_indent = len(line) - len(line.lstrip())
        i1 = " " * (base_indent + 4) # Sub 'with'
        i2 = i1 + "    "             # Sub 'try'
        i3 = i2 + "    "             # Sub 'if data'
        i4 = i3 + "    "             # Sub 'for cat'
        
        new_lines.append(f"{i1}# --- AXON GESTIUNE V53 (PROGRES REAL & INDENTARE) ---\n")
        ...
        # AGREGĂM DATELE: Adunăm Validările de la toți contractorii pe același Material de Bază
        ...
        new_lines.append(f"{i4}        # Calculăm Progresul Real (Validat vs Planificat)\n")
        ...
        # Configurare Tabel cu Bare de Progres Verzi (Streamlit folosește tema, dar îi dăm formatare %)
        ...
        new_lines.append(f"{i4}                             'Status Realizare', \n")
