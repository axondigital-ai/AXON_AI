...
for line in lines:
    if "with tabs[2]:" in line:
        ...
        # Stilul rămâne același: Procent + Bară Verde Orizontală
        ...
        # SCHIMBARE CHEIE: Folosim st.dataframe în loc de st.write(html)
        new_lines.append(f"{i4}        st.dataframe(styled_df, use_container_width=True, hide_index=True)\n")
        ...
        # Folosim st.dataframe și aici pentru consistență
