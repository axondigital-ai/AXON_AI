...
for line in lines:
    ...
    if "with tabs[2]:" in line:
        ...
        new_lines.append(i1 + "# --- START AXON GESTIUNE V25 (FULL VISIBILITY) ---\n")
        ...
        # ADĂUGĂM COLOANELE LIPSA: Cantitate_Instalata și Contractor_Custodie
        new_lines.append(i3 + "            cols = ['Material', 'Cod_PVcase', 'Cantitate_Planificata', 'Cantitate_Receptionata', 'Cantitate_Custodie', 'Cantitate_Instalata', 'Contractor_Custodie', 'Status']\n")
        ...
        new_lines.append(i1 + "# --- END AXON GESTIUNE V25 ---\n")

with open(file_path, "w") as f:
    f.writelines(new_lines)

print("✅ [FIX V25]: Coloana 'Instalat' si 'Contractor' sunt acum vizibile.")
