...
for line in lines:
    ...
    if "with tabs[2]:" in line:
        ...
        new_lines.append(i1 + "# --- START AXON GESTIUNE V27 (SUMMARY + CUSTODY) ---\n")
        ...
        # Curățăm numele materialelor pentru a grupa loturile sub același nume
        new_lines.append(i3 + "df['Material_Baza'] = df['Material'].apply(lambda x: x.split(' (')[0])\n")
        ...
        # Arătăm doar rândurile care au ceva în custodie sau instalat
        ...
        new_lines.append(i1 + "# --- END AXON GESTIUNE V27 ---\n")

with open(file_path, "w") as f:
    f.writelines(new_lines)

print("✅ [UI V27.0]: Arhitectură Summary + Custody Details activată.")
